...
function SectionTitle({ index, title }: { index: string; title: string }) {
  return (
    <div className="flex items-center gap-3 border-b-2 border-slate-100 pb-3">
      ...
      <h3 className="text-lg font-black uppercase tracking-tight text-slate-800 sm:text-base">{title}</h3>
    </div>
  );
}
    ...
    <div className="space-y-10 p-5 sm:space-y-12 sm:p-12">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 md:grid-cols-2">
          <div className="md:col-span-2">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-5 py-4">
              <p className="text-base font-bold uppercase tracking-wide text-slate-700 sm:text-sm">
                Mã tra cứu
              </p>
              <div className="mt-2 flex items-center justify-between gap-4">
                <p className="text-xl font-black tracking-[0.12em] text-slate-900 sm:text-lg">
      ...
      <section className="space-y-7 sm:space-y-8">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <label className="mb-4 block text-base font-bold uppercase tracking-wide text-slate-700 sm:text-sm">
      ...
      {errors.length > 0 ? (
        ...
        >
          ...
          <div>
            <p className="mb-2 text-base font-black uppercase tracking-wider sm:text-sm">Vui lòng kiểm tra lại:</p>
      ...
      {lookupCodeError ? (
        <motion.div
          ...
          initial={{ opacity: 0, y: 10 }}
        >
          <p className="font-black uppercase tracking-[0.16em]">Không tạo được Mã tra cứu</p>
